        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-8 p-6">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground text-lg">Here's an overview of the association's activities and your account.</p>
                </div>
                ...
                <Card className="hover:shadow-md transition-shadow duration-200 mb-8">
                    ...
                    <CardContent>
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                            <Button asChild variant="outline" className="h-20 flex-col gap-2 hover:bg-muted/50">
                                <Link href="/contributions">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            {recentContributions.slice(0, 3).map((contribution: any) => (
                                                <div key={contribution.id} className="flex items-center justify-between text-sm p-2 rounded-md hover:bg-muted/50">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            {recentLoans.slice(0, 3).map((loan: any) => (
                                                <div key={loan.id} className="flex items-center justify-between text-sm p-2 rounded-md hover:bg-muted/50">
